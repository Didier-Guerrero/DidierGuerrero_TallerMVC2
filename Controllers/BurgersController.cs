...
namespace DidierGuerrero_TallerMVC2.Controllers
{
    ...
    {
        private readonly DidierGuerrero_TallerMVC2Context _context;

        public BurgersController(DidierGuerrero_TallerMVC2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'DidierGuerrero_TallerMVC2Context.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DidierGuerrero_TallerMVC2Context.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
